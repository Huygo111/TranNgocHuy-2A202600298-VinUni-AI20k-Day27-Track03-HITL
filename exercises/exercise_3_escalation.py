    ...
    with console.status("[dim]LLM reviewing the diff...[/dim]"):
        analysis = llm.invoke([
            {"role": "system", "content": (
                ...
                "specific, context-rich questions that reference the file or diff area "
    ...
    refined = llm.invoke([
        {
            "role": "system",
            "content": (
                "You are refining an earlier PR review using reviewer answers. "
                "Produce a fresh structured review with updated confidence, comments, "
                "risk factors, and any remaining escalation questions only if still needed."
            ),
        },
        {
            "role": "user",
